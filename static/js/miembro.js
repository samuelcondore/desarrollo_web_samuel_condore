...
if (row1) {
    row1.addEventListener("click", (e) => {
        const id_actividad = document.getElementById("1").dataset.id;
        window.location.href = "/actividad?id="+id_actividad;
    });
}
const row2 = document.getElementById("2");
if (row2) {
    row2.addEventListener("click", (e) => {
        const id_actividad = document.getElementById("2").dataset.id;
        window.location.href = "/actividad?id="+id_actividad;
    });
}
...
if (row3) {
    row3.addEventListener("click", (e) => {
        const id_actividad = document.getElementById("3").dataset.id;
        window.location.href = "/actividad?id="+id_actividad;
    });
}
...
if (row4) {
    row4.addEventListener("click", (e) => {
        const id_actividad = document.getElementById("4").dataset.id;
        window.location.href = "/actividad?id="+id_actividad;
    });
}
...
if (row5) {
    row5.addEventListener("click", (e) => {
        const id_actividad = document.getElementById("5").dataset.id;
        window.location.href = "/actividad?id="+id_actividad;
    });
}